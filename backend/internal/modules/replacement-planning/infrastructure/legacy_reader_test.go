...
func (fakeDatasetRepo) ReplaceValueScoreOriginalValues(ctx context.Context, rows []domain.ValueScoreOriginalValue) error {
	_ = ctx
	_ = rows
	return nil
}
func (fakeDatasetRepo) ListValueScoreOriginalValues(ctx context.Context) ([]domain.ValueScoreOriginalValue, error) {
	_ = ctx
	return nil, nil
}
func (fakeDatasetRepo) ReplaceValueScorePerformanceParams(ctx context.Context, rows []domain.ValueScorePerformanceParam) error {
	_ = ctx
	_ = rows
	return nil
}
func (fakeDatasetRepo) ListValueScorePerformanceParams(ctx context.Context) ([]domain.ValueScorePerformanceParam, error) {
	_ = ctx
	return nil, nil
}
