...
func NewRouter(h Handlers) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.GET("/delivery-decision/config", h.DeliveryDecision.GetConfig)
		v1.PUT("/delivery-decision/config", h.DeliveryDecision.SaveConfig)
		...
		v1.GET("/renewals/plans/:plan_id/comparison/reduced/export", h.Renewal.ExportComparisonReduced)
		...
		v1.GET("/resource-planning/result/latest", h.ResourcePlanning.GetLatestResult)
